...
(function() {
  ...
  Crafty.c("Damagable", {
    ...
    take_dmg: function(bullet) {
      ...
      if (this.shield_stat > 0) {
        this.shield_stat -= bullet.shield_dmg;
        if (this.shieldvis) {
          return this.shieldvis.hit();
        }
      } else {
        this.armor_stat -= bullet.armor_dmg;
        Crafty.e("2D, DOM, SpriteAnimation, Explosion").attr({
          x: bullet.x - 20,
          y: bullet.y - 20
        }).animate("explode", 0, 0, 10).animate("explode", 5, 0);
        if (this.armor_stat <= 0) {
          return this.removeComponent("Damagable");
        }
      }
    },
    regen_shields: function() {
      ...
      if (this.shield_stat > 0 && this.shield_stat < this.shields) {
        ...
        if (this.shield_stat > this.shields) {
          this.shield_stat = this.shields;
        }
      } else {
  ...
  Crafty.c("ShieldVis", {
    ...
    shieldVis: function(ship) {
      this.ship = ship;
      this.image(this.ship.filename + "_shield.png");
      this.x = -7;
      this.y = -7;
      this.alpha = 0.0;
  ...
  Crafty.c("Ship", {
    ...
    ship: function() {
      this.shieldvis = Crafty.e("ShieldVis");
      return this.shieldvis.shieldVis(this);
    },
    get_dir: function() {
    ...
    is_valid_target: function(target, center, radius) {
      ...
      if (center && radius < this.get_min_turn_radius()) {
        return false;
      }
      return true;
    },
